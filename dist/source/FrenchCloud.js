...
exports.FrenchCloud = void 0;
const cheerio = __importStar(require("cheerio"));
const types_1 = require("../types");
const utils_1 = require("../utils");
const Source_1 = require("./Source");
class FrenchCloud extends Source_1.Source {
    id = 'frenchcloud';
    label = 'FrenchCloud';
    contentTypes = ['movie'];
    countryCodes = [types_1.CountryCode.fr];
    baseUrl = 'https://frenchcloud.cam';
    fetcher;
    constructor(fetcher) {
        super();
    ...
    async handleInternal(ctx, _type, id) {
        ...
        return Promise.all($('[data-link!=""]')
            ...
            .map(url => ({ url, meta: { countryCodes: [types_1.CountryCode.fr], referer: this.baseUrl } })));
    }
    ;
}
exports.FrenchCloud = FrenchCloud;
