...
exports.StreamKiste = void 0;
const cheerio = __importStar(require("cheerio"));
const types_1 = require("../types");
const utils_1 = require("../utils");
const Source_1 = require("./Source");
class StreamKiste extends Source_1.Source {
    id = 'streamkiste';
    label = 'StreamKiste';
    contentTypes = ['series'];
    countryCodes = [types_1.CountryCode.de];
    baseUrl = 'https://streamkiste.taxi';
    fetcher;
    constructor(fetcher) {
        super();
    ...
    async handleInternal(ctx, _type, id) {
        ...
        return Promise.all($(`[data-num="${tmdbId.season}x${tmdbId.episode}"]`)
            ...
            .map(url => ({ url, meta: { countryCodes: [types_1.CountryCode.de], referer: seriesPageUrl.href, title } })));
    }
    ;
...
exports.StreamKiste = StreamKiste;
