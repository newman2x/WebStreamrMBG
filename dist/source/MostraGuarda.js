...
exports.MostraGuarda = void 0;
const cheerio = __importStar(require("cheerio"));
const types_1 = require("../types");
const utils_1 = require("../utils");
const Source_1 = require("./Source");
class MostraGuarda extends Source_1.Source {
    id = 'mostraguarda';
    label = 'MostraGuarda';
    contentTypes = ['movie'];
    countryCodes = [types_1.CountryCode.it];
    baseUrl = 'https://mostraguarda.stream';
    fetcher;
    constructor(fetcher) {
        super();
    ...
    async handleInternal(ctx, _type, id) {
        ...
        return Promise.all($('[data-link!=""]')
            ...
            .map(url => ({ url, meta: { countryCodes: [types_1.CountryCode.it], referer: this.baseUrl } })));
    }
    ;
}
exports.MostraGuarda = MostraGuarda;
